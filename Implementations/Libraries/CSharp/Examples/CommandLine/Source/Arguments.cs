...
public static class Arguments{
	...
	/// <summary>Requires that the named argument is provided. Returns the arg value.</summary>
	public static string Require(string arg,string descrip){
		...
		if( string.IsNullOrEmpty(value) ){
			...
			// Not provided:
			throw new Exception("Please provide an '"+arg+"' argument. "+descrip+".");
