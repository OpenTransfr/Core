...
// Creates a new number system. Requires a registered root Entity.
postedTo();
...
// Is the code taken?
$row=$dz->get_row('select ID from `Merchant.ProductNumberSystems` where `Code`="'.$code.'"');
...
// Create the row now:
$dz->query('insert into `Merchant.ProductNumberSystems`(`Code`,`Name`,`Endpoint`,`RegisteredBy`) values ("'.$code.'","'.
