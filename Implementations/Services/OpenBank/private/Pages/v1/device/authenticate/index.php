...
$row=$dz->get_row('select `Sequence` from `Bank.Devices` where ID='.$verifiedDevice);
...
$account=$dz->get_row('select FullName from `Bank.Accounts` where ID='.$verifiedAccount);
